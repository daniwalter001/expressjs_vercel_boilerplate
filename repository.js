...
const discoverTVShows = (
  ...
  let url =
    `https://api.themoviedb.org/3/discover/tv?include_adult=false&include_null_first_air_dates=false&language=fr-FR&vote_average.gte=${vote_average}&vote_count.gte=${vote_count}&first_air_date.lte=${today}&with_keywords=9675` +
    (providerID
